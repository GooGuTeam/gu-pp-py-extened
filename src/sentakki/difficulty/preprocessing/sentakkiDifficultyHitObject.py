"""
SentakkiDifficultyHitObject类，用于表示难度计算中的击打物件
"""
...
class SentakkiDifficultyHitObject:
    ...
    def __init__(self, hit_object: 'SentakkiHitObject', last_object: 'SentakkiHitObject', 
                 clock_rate: float, objects: List['SentakkiDifficultyHitObject'], index: int):
        """
        初始化Sentakki难度击打物件
    ...
    def previous(self, backwards_index: int) -> 'Optional[SentakkiDifficultyHitObject]':
        """
        获取前一个物件
        ...
        Returns:
            Optional[SentakkiDifficultyHitObject]: 前一个物件或 None
        """
